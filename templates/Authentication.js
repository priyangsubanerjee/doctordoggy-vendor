export const LoginSuccess = (email, browserAgent, date, mode) => {
  return `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
export const OTPSent = (email, otp, browserAgent, date) => {
  return `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    ...
    <div class="container">
      <div class="messageBox">
        ...
        <p style="font-weight: 400; line-height: 1.9; margin-top: 30px">
          ...
          <span style="color: rgb(34, 74, 237)">(${email})</span> . If this
          wasn't you, you can ignore this email. If you're having trouble with
