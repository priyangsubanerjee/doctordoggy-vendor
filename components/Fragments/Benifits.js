...
function Benifits() {
  return (
    <div className="mt-40 lg:mt-44 px-6 lg:px-24">
      ...
      <h1 className="text-2xl font-semibold text-slate-900 text-center mt-2">
        Simplifying from the root
      </h1>
      <div className="mt-12 max-w-5xl mx-auto">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
          <div className="h-44 lg:h-60 col-span-2 bg-slate-100 rounded-xl"></div>
          <div className="h-32 lg:h-60 lg:col-span-1 bg-slate-100 rounded-xl"></div>
          <div className="h-32 lg:h-60 lg:col-span-1 bg-slate-100 rounded-xl"></div>
        </div>
