...
function Herosection() {
  return (
    <div className="pt-2 lg:pt-0 px-0 md:px-6 lg:px-24">
      <div className="md:rounded-2xl h-[300px] md:h-[500px] flex overflow-hidden md:bg-[url(https://img.freepik.com/free-vector/gradient-blur-pink-blue-abstract-background_53876-117324.jpg)] bg-no-repeat bg-cover">
